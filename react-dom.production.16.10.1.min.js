...
*/
'use strict';(function(la,l){"object"===typeof exports&&"undefined"!==typeof module?module.exports=l(require("react")):"function"===typeof define&&define.amd?define(["react"],l):la.ReactDOM=l(la.React)})(this,function(la){function l(a){for(var b=a.message,c="https://web.archive.org/web/20220528010405/https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";
...
/*
     FILE ARCHIVED ON 01:04:05 May 28, 2022 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  capture_cache.get: 3.081
  load_resource: 141.994 (2)
  PetaboxLoader3.resolve: 89.674 (2)
  PetaboxLoader3.datanode: 26.298 (2)
*/